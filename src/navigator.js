...
import SelectSeed from './view/select-seed';
...
import RestoreSeed from './view/restore-seed';
import RestorePassword from './view/restore-password';
import Password from './view/password';
import NewAddress from './view/new-address';
import LoaderSyncing from './view/loader-syncing';
...
import PaymentFailed from './view/payment-failed';
      ...
      <Router history={history}>
        <Container>
          ...
          <Route
            exact
            path="/seed-success"
            render={() => <SeedSuccess wallet={wallet} />}
          />
          <Route
            exact
            path="/set-password"
          ...
          <Route
            exact
            path="/restore-seed"
            render={() => <RestoreSeed store={store} wallet={wallet} />}
          />
          <Route
            exact
          ...
          <Route
            exact
            path="/loader-syncing"
            render={() => <LoaderSyncing store={store} />}
          />
          ...
          <Route
            exact
            path="/cli"
            render={() => <CLI store={store} nav={nav} />}
          />
          <Route
            exact
            path="/payment"
          ...
          <Route
            exact
            path="/payment-failed"
            render={() => <PaymentFailed channel={channel} nav={nav} />}
          />
          <Route
            exact
            path="/pay-bitcoin"
